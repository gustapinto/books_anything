...
func RegisterRoutes(router *gin.Engine) {
	userRepository := &repository.UserCassandraRepository{}
	authorRepository := &repository.AuthorCassandraRepository{}
	bookRepository := &repository.BookCassandraRepository{}
